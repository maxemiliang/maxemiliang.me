...
var animateBG = function animateBG() {
  document.querySelector('.animated-bg').style.cssText = "width: ".concat(window.scrollY * 0.09, "%");
};

var setupClick = function setupClick() {
  document.querySelector('.hero .arrow').addEventListener('click', function () {
    window.scrollTo({
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3460" + '/');
